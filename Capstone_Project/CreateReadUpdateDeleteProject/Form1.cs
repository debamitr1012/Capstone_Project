...
namespace CreateReadUpdateDeleteProject
{
    public partial class Form1 : Form
    {
        ...
        //SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\WINDOWS 10\Documents\crud.mdf;Integrated Security=True;Connect Timeout=30");
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\Users\debaymitra\OneDrive - Deloitte (O365D)\Documents\crud.mdf"";Integrated Security=True;Connect Timeout=30");
        public Form1()
        {
            InitializeComponent();
                ...
                if(connect.State != ConnectionState.Open)
                {
                    try
                    {
                        ...
                        string insertData = "INSERT INTO users " +
                            "(full_Name, gender, contact, email, bith_date, date_update) " +
